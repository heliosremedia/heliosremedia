...
function fixture() {
 const state = { writes: 0, heads: 0, deletes: 0, owner: 'a', status: 'UPLOAD_PROVISIONED', registered: false, provenance: { kind: 'WORK_CARD_UPLOAD', cardId: 'c1', mediaKind: 'image' }, existing: { id: 'c1', serviceId: 's1', imageStorageKey: null as string|null, imageUrl: null as string|null, videoStorageKey: null, videoUrl: null, mediaMode: 'IMAGE', service: { slug: 's1' } } };
