...
for(const [key,value] of Object.entries({VERCEL_ENV:'production',VERCEL_PROJECT_ID:'prj_FPZa82WCG2w4oxJzf7DEV04ChuWB',VERCEL_ORG_ID:'foreign',VERCEL_GIT_COMMIT_REF:'main',VERCEL_GIT_COMMIT_SHA:'c'.repeat(40),STAGING_CANDIDATE_SHA:'bad',STUDIO_V2_TENANT_CONTEXT_ENABLED:'false',AUTH_SECRET:'short',DATABASE_URL:'postgresql://x:y@production.invalid/prod?sslmode=require',DIRECT_URL:'postgresql://x:y@production.invalid/prod?sslmode=require',CRON_SECRET:'present',R2_ACCESS_KEY_ID:'present',RESEND_API_KEY:'present',OPENAI_API_KEY:'present',SOCIAL_TOKEN_ENCRYPTION_KEY:'present',STUDIO_V2_LOCAL_WORKSPACE_SLUG:'packet16-a'})){
