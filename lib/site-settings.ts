...
export const defaultSiteSettings: PublicSiteSettings = {
  ...
  standardHeadingLineOne: "Media with",
  standardHeadingLineTwo: "Measured Intention",
  standardBody: "Every frame is composed with purpose—guiding attention, creating emotion, and revealing what makes the property exceptional.",
