...
const STUDIO_RELEASE_AUDIT: readonly StudioRelease[] = [
  {
    ...
    improvements: ["Immutable publishing snapshots target the exact selected destination", "Instagram container processing is verified before a post is marked published", "Provider failures are translated into safe, actionable administrator guidance"],
