...
- In progress: `codex/v2-social-analytics-observation-ordering` builds on #296. The canonical claim identifies the published head. See the observation-ordering entry below for scope and verification; final publication/CI evidence will follow.
- Latest implementation: draft [#296](https://github.com/heliosremedia/heliosremedia/pull/296), branch `codex/v2-social-analytics-claim-fencing`, remote code head `5765369170bb41e155ee37d67a6600f09620247a`, tree `89c1c08d9789c7653b3a4e351d3796634d3ba3cf`. Local `f5961bb31b95730e9d58a6fc8229cc12d327554a` has the identical tree. This ledger checkpoint is a documentation-only follow-up; the canonical claim records the final published branch head.
- Verification: all 652 tests passed locally and in [GitHub run 34714309188](https://github.com/heliosremedia/heliosremedia/actions/runs/34714309188). Fresh-runner Prisma generation, non-incremental TypeScript, real Chromium synthetic recovery/job-view interactions and whitespace all passed. No authenticated hosted HTTP, Neon concurrency or deployed workflow parity is implied.
- Recent drafts: #294 newsletter execution/settlement evidence, #295 social analytics publication ownership and #296 analytics claim fencing with atomic batched persistence. All have verified implementation CI. Main remains `72dab34568cb6885f3e93b5ed9db38edca156835`; no production merge or deployment occurred.
- Phase 1 isolation exit remains open while Phase 2 reliability work advances. Next dependencies: social publishing settlement reproduction/review, deliberate recovery of held analytics jobs, connection-health observation ordering, and shared-job convergence. Retain current token/version fencing and explicit recovery. Broader ownership audit, hosted concurrency/restoration, full-batch transaction measurements and full-stack negative tests remain necessary before later product/commercial phases or Jake's QA gate.
