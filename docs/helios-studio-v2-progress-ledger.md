...
- Active implementation: `codex/v2-social-publishing-settlement` builds on #297. Internal publishing settlement and claim admission are under isolated verification; see the new entry below. Canonical control claim identifies the live owner and publication head.
- Latest implementation: draft [#297](https://github.com/heliosremedia/heliosremedia/pull/297), branch `codex/v2-social-analytics-observation-ordering`, remote code head `5ed949f78b06ac9fb7f7ab008acecf52e46d3e53`, tree `1641f9be1d07b76ab9af3f3cb104d07ba7746a9a`. Local `5349605dc96d8d176fed212c4d6b26e0b240b0f2` has the identical tree. This ledger checkpoint is a documentation-only follow-up; the canonical claim records the final published branch head.
- Verification: all 655 tests passed locally and in [GitHub run 34715541843](https://github.com/heliosremedia/heliosremedia/actions/runs/34715541843). Fresh-runner Prisma generation, non-incremental TypeScript, real Chromium synthetic recovery/job-view interactions and whitespace all passed. No authenticated hosted HTTP, Neon concurrency or deployed workflow parity is implied.
- Recent drafts: #295 analytics publication ownership, #296 atomic claim-fenced metrics and #297 connection-health ordering plus due-time claim revalidation. All have verified implementation CI. Main remains `72dab34568cb6885f3e93b5ed9db38edca156835`; no production merge or deployment occurred.
- Phase 1 isolation exit remains open while Phase 2 reliability work advances. Next dependencies: social publishing settlement reproduction/review, deliberate recovery of held analytics jobs, per-attempt chronology for equal queue timestamps, and shared-job convergence. Retain current token/version fencing and explicit recovery. Broader ownership audit, hosted concurrency/restoration, UTC/Prisma integration, full-batch transaction measurements and full-stack negative tests remain necessary before later product/commercial phases or Jake's QA gate.
