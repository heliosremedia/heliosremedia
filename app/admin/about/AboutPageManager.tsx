...
export default function AboutPageManager({ initialContent, initialTeamMembers }: { initialContent: PublicAboutPageContent; initialTeamMembers: AdminTeamMember[] }) {
  ...
  return <div className="space-y-7">
    ...
    <Panel id="about-founder" {...panel("about-founder")} eyebrow="Personal connection" title="Founder profile" description="Introduce the person behind the company. Upload a portrait, edit every line, then publish the section when it is ready.">
      ...
      <div className="grid gap-5 lg:grid-cols-[minmax(0,0.8fr)_minmax(0,1.2fr)]">
        ...
        <div className="grid content-start gap-4 sm:grid-cols-2">
          ...
          <div className="sm:col-span-2"><Textarea label="Founder story" value={content.founderBody} onChange={(value) => field("founderBody", value)} rows={10} maxLength={2400} /></div>
    ...
    <Panel id="about-team" {...panel("about-team")} eyebrow="People" title="Team members" description="Create ordered, visible public team profiles with titles, biographies, categories, and uploaded portraits.">
...
function Textarea({ label, value, onChange, rows, maxLength }: { label: string; value: string; onChange: (value: string) => void; rows: number; maxLength?: number }) {
