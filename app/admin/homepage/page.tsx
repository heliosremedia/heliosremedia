...
export default async function HomepageCurationPage() {
  ...
  return <div className="space-y-7"><section className="border-b border-white/[0.08] pb-7"><p className="eyebrow text-[var(--helios-orange)]">Public presentation</p><h1 className="mt-3 text-3xl font-light tracking-[-0.03em] text-white sm:text-4xl">Homepage curation</h1><p className="mt-3 max-w-2xl text-sm leading-6 text-white/40">Choose up to five published projects for the homepage. The first placement receives the cinematic hero-card treatment.</p></section><HomepageProjectManager initialPlacements={serialized} projects={projects as ProjectOption[]} /></div>;
}
