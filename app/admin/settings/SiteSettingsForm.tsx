  ...
  return (
    <div>
      ...
      <section className={`mt-6 rounded-2xl border p-6 ${settings.bookingMode === "ONLINE" ? "border-white/[0.08] bg-[#111]" : "border-[var(--helios-orange)]/45 bg-[var(--helios-orange)]/[0.045]"}`}>
        <div className="flex flex-wrap items-start justify-between gap-4"><div><p className="eyebrow text-[var(--helios-orange)]">Global control</p><h2 className="mt-2 text-2xl font-light text-white">Booking availability</h2><p className="mt-2 text-sm text-white/38">Every public booking action routes through Helios and follows this saved mode.</p></div>{settings.bookingMode !== "ONLINE" && <span className="rounded-full border border-[var(--helios-orange)]/40 px-3 py-1.5 text-xs uppercase tracking-[.12em] text-[var(--helios-orange)]">Booking not online</span>}</div>
