...
const imageFields = [
  ...
  { storage: "founderImageStorageKey", url: "founderImageUrl", alt: "founderImageAlt" },
...
export async function PATCH(request: Request) {
  try {
    ...
    const data = {
      ...
      founderEnabled: body.founderEnabled === true,
      founderEyebrow: requiredText(body.founderEyebrow, 120),
      founderFirstName: requiredText(body.founderFirstName, 120),
      founderRole: requiredText(body.founderRole, 180),
      founderBody: requiredText(body.founderBody, 2400),
      founderSignature: requiredText(body.founderSignature, 180),
      founderTitle: requiredText(body.founderTitle, 180),
      founderTeamNote: requiredText(body.founderTeamNote, 800),
      founderImageStorageKey: images.founderImageStorageKey,
      founderImageUrl: images.founderImageUrl,
      founderImageAlt: images.founderImageAlt as string,
