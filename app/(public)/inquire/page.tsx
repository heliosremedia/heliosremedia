...
export default async function InquiryPage() {
  ...
  const services = await prisma.service.findMany({ where: { workspaceId, active: true, archivedAt: null }, orderBy: [{ displayOrder: "asc" }, { name: "asc" }], select: { id: true, name: true, description: true } });
