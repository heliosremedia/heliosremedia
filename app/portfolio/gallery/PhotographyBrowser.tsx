...
export default function PhotographyBrowser({ initialItems, initialNextOffset, total }: { initialItems: DiscoveryPhoto[]; initialNextOffset: number | null; total: number }) {
  ...
  return <>
    ...
    <div className="mt-6 columns-2 gap-1.5 md:columns-3 md:gap-2 xl:columns-4 2xl:columns-5">
      {visibleItems.map((item) => <figure key={item.id} className="mb-1.5 break-inside-avoid overflow-hidden bg-white/[0.025] md:mb-2">
