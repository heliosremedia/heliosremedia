                ...
                <div className="container-shell grid gap-12 py-20 sm:py-28 lg:grid-cols-[minmax(20rem,0.72fr)_minmax(0,1.28fr)] lg:items-center lg:gap-20">
                  <div className={serviceIndex % 2 === 1 ? "lg:order-2" : ""}>
                    ...
                    <div className="mt-9 flex flex-wrap items-center gap-4">
                      ...
                      {serviceMediaCategories.includes("PHOTOGRAPHY") && <Link href="/photo-finishes#compare" className="inline-flex min-h-12 items-center text-[.58rem] font-semibold uppercase tracking-[.16em] text-[var(--helios-orange)] transition hover:text-white">Compare Photo Finishes</Link>}
