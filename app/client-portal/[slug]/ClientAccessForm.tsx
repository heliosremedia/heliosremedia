...
export default function ClientAccessForm({ slug }: { slug: string }) {
  ...
  return <form onSubmit={submit} className="mt-10 border-t border-white/10 pt-8">
    ...
    <p className="mt-4 text-xs leading-5 text-white/30">Enter the email associated with your client account. If it is eligible, we’ll send a secure, time-limited access link.</p>
